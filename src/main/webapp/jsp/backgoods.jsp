...
<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h3 class="page-header">客户退货</h3>

          <div class="row placeholders">
          <form class="form-inline">
          	<div class="form-group">
              <label for="exampleInputName2">退货类型：</label>
              <select class="form-control" value="请选择退货类型" tabindex="1" name="providerlist" id="queProviderName">
              	<option value="">请选择退货类型</option>
              	<option value="">供应商退货</option>
              	<option value="">客户退货</option>
              </select>
            </div>
