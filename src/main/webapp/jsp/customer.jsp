...
<html>
  <head>
	<script src="${RESOURCE_PATH}/emall/global-theme/jquery/jquery-1.10.1.min.js"></script>
    <meta charset="utf-8">
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li class="active"><a href="./customer.html">客户管理<span class="sr-only">(current)</span></a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <form class="form-inline">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="exampleInputName2" placeholder="客户名称">
            </div>
            <div class="form-group">
          ...
          <div class="row placeholders ">
            <div class="col-sm-5">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addcustomer">新增客户</button>
            <button type="button" id="delbtn" class="btn btn-primary">批量删除客户</button>
            <button type="button" id="delcommit" class="btn btn-primary" style="display:none">确认删除客户</button>
            ...
            <table class="table table-striped">
              ...
              <tbody>
                <tr>
                  ...
                  <td>朝阳</td>
                  <td>朝阳区朝阳路18号</td>
                  <td><a href="#" data-toggle="modal" data-target="#modifycustomer">修改</a>/<a href="#">删除</a></td>
                </tr>
                <tr>
                  <td class="chk" style="display:none"><input type="checkbox" aria-label="..."></td>
                  <td>2</td>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="row">
              ...
              <div class="input-group col-xs-6 col-md-offset-3">
                <span class="input-group-addon" style="background-color: #1abc9c;">客户地址:</span>
                <input type="text" class="form-control" placeholder="客户地址">
              </div>              
              <div class="input-group col-xs-6 col-md-offset-3">
                <span class="input-group-addon" style="background-color: #1abc9c;">客户电子邮箱:</span>
                <input type="text" class="form-control" placeholder="客户电子邮箱">
              </div>
              <div class="input-group col-xs-6 col-md-offset-3">
                <span class="input-group-addon" style="background-color: #1abc9c;">客户地域：</span>
                <input type="text" class="form-control" placeholder="客户地域：">
              </div>
              <div class="input-group col-xs-6 col-md-offset-3">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="row">
              <div class="input-group col-xs-6 col-md-offset-3">
                <span class="input-group-addon" style="background-color: #1abc9c;">客户名称:</span>
                <input type="text" class="form-control" placeholder="客户名称" value="张老坎">
              </div>    
              <div class="input-group col-xs-6 col-md-offset-3">
                <span class="input-group-addon" style="background-color: #1abc9c;">客户类型:</span>
                <select class="form-control" value="请选择客户类型：" tabindex="1" name="herolist">
              ...
              <div class="input-group col-xs-6 col-md-offset-3">
                <span class="input-group-addon" style="background-color: #1abc9c;">客户地址:</span>
                <input type="text" class="form-control" placeholder="客户地址" value="朝阳区朝阳路18号">
              </div>              
              <div class="input-group col-xs-6 col-md-offset-3">
                <span class="input-group-addon" style="background-color: #1abc9c;">客户电子邮箱:</span>
                <input type="text" class="form-control" placeholder="客户电子邮箱" value="zhanglk@163.com">
              </div>
              <div class="input-group col-xs-6 col-md-offset-3">
                <span class="input-group-addon" style="background-color: #1abc9c;">客户地域：</span>
                <input type="text" class="form-control" placeholder="客户地域：" value="朝阳">
              </div>
              <div class="input-group col-xs-6 col-md-offset-3">
                <span class="input-group-addon" style="background-color: #1abc9c;">备注：</span>
