...
public class GoodsToCustomerLog {
    private Integer logId;

    private Date logDatetime;

    private String goods2customerId;
    ...
    public String getGoods2customerId() {
        return goods2customerId;
    }

    public void setGoods2customerId(String goods2customerId) {
        this.goods2customerId = goods2customerId == null ? null : goods2customerId.trim();
    }
